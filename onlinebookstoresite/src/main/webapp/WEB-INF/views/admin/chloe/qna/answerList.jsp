	...
	<div class="container-fluid">
		...
		<div class="container">
			<ul class="nav nav-pills nav-justified">
				<li class="nav-item">
					<a class="nav-link btn btn-outline-success qnaSelector" href="${pageContext.request.contextPath}/unAnswerList">미답변</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active btn btn-outline-success qnaSelector" href="${pageContext.request.contextPath}/answerList">답변완료&nbsp;[${pu.totalRowCnt }건]</a>
				</li>
			</ul>
		</div>
		<br>
					...
					<c:forEach var="vo" items="${list }">
						<tr>
							...
							<td style="text-align: left;">${vo.qnatitle }&nbsp;&nbsp;&nbsp;
								<a class="btn-outline-success" href="${pageContext.request.contextPath}/answerDetail?qnanum=${vo.qnanum}">더보기</a>
							</td>
				...
				<div id="listPaging">
					<c:choose>
						<c:when test="${pu.startPageNum > 1 }">
							<button onclick="location.href='${pageContext.request.contextPath }/answerList?pageNum=${pu.startPageNum - 1}'"
					...
					<c:forEach var="i" begin="${pu.startPageNum }" end="${pu.endPageNum }">
						<c:choose>
							<c:when test="${i == pu.pageNum }">
								<button onclick="location.href='${pageContext.request.contextPath }/answerList?pageNum=${i}'"
					...
					<c:choose>
						<c:when test="${pu.totalPageCnt > pu.endPageNum }">
							<button onclick="location.href='${pageContext.request.contextPath }/answerList?pageNum=${pu.endPageNum + 1}'"
